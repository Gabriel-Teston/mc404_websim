...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5320880,
    DYNAMIC_BASE = 5320880,
    DYNAMICTOP_PTR = 77744;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=77792;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
var real____em_js__jsReadMMIO = asm["___em_js__jsReadMMIO"]; asm["___em_js__jsReadMMIO"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__jsReadMMIO.apply(null, arguments);
};

var real____em_js__jsWriteMMIO = asm["___em_js__jsWriteMMIO"]; asm["___em_js__jsWriteMMIO"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__jsWriteMMIO.apply(null, arguments);
};

var real____em_js__readFromGDB = asm["___em_js__readFromGDB"]; asm["___em_js__readFromGDB"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__readFromGDB.apply(null, arguments);
};

var real____em_js__writeToGDB = asm["___em_js__writeToGDB"]; asm["___em_js__writeToGDB"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__writeToGDB.apply(null, arguments);
};
