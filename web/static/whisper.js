...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 89872,
    DYNAMIC_BASE = 5332752,
    DYNAMICTOP_PTR = 89712;
...
var ASM_CONSTS = [];
function writeToGDB(str){ var jsString = UTF8ToString(str); sendDebugMsg(jsString); }
function jsExternalInterrupt(){ var value = intController.interrupt; return value; }
function jsWriteMMIO(addr,size,value){ mmio.store(addr, size, value); }
function jsReadMMIO(addr,size){ var value = mmio.load(addr, size); return value; }
function jsInterruptEnabled(){ var value = intController.interruptEnabled; return value; }
function customSyscall(a0,a1,a2,a3,a7){ var value = syscall_emulator.run(a0, a1, a2, a3, a7); return value; }
function readInteractiveCommand(){ var jsString = getInteractiveCommand(); var lengthBytes = lengthBytesUTF8(jsString)+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; }
function readFromGDB(){ var jsString = getDebugMsg(); var lengthBytes = lengthBytesUTF8(jsString)+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; }



// STATICTOP = STATIC_BASE + 88848;
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_throw": ___cxa_throw, "__lock": ___lock, "__map_file": ___map_file, "__syscall10": ___syscall10, "__syscall102": ___syscall102, "__syscall12": ___syscall12, "__syscall122": ___syscall122, "__syscall183": ___syscall183, "__syscall192": ___syscall192, "__syscall194": ___syscall194, "__syscall195": ___syscall195, "__syscall197": ___syscall197, "__syscall199": ___syscall199, "__syscall200": ___syscall200, "__syscall201": ___syscall201, "__syscall202": ___syscall202, "__syscall221": ___syscall221, "__syscall295": ___syscall295, "__syscall3": ___syscall3, "__syscall300": ___syscall300, "__syscall301": ___syscall301, "__syscall305": ___syscall305, "__syscall4": ___syscall4, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall91": ___syscall91, "__unlock": ___unlock, "abort": _abort, "customSyscall": customSyscall, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "gettimeofday": _gettimeofday, "jsExternalInterrupt": jsExternalInterrupt, "jsInterruptEnabled": jsInterruptEnabled, "jsReadMMIO": jsReadMMIO, "jsWriteMMIO": jsWriteMMIO, "memory": wasmMemory, "pthread_create": _pthread_create, "pthread_join": _pthread_join, "readFromGDB": readFromGDB, "readInteractiveCommand": readInteractiveCommand, "setTempRet0": _setTempRet0, "sigaction": _sigaction, "sigemptyset": _sigemptyset, "strftime_l": _strftime_l, "table": wasmTable, "times": _times, "writeToGDB": writeToGDB };
var asm = createWasm();
